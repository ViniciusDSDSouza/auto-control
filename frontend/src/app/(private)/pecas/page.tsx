      ...
      <Stack gap={6}>
        <Box>
          ...
          <Box fontSize="lg" color="gray.600" mt={1}>
            Gerencie seu estoque de peças, atualize preços e mantenha tudo
            organizado
          </Box>
        </Box>
            ...
            <Table.Root>
              ...
              <Table.Body>
                {parts.length === 0 ? (
                  ...
                  parts.map((part) => (
                    <Table.Row key={part.id} _hover={{ bg: "orange.50" }}>
                      <Table.Cell fontSize="lg" minW="200px" pl={4}>
                        {part.name}
                      </Table.Cell>
                      <Table.Cell fontSize="lg" color="gray.600" minW="150px">
                        {part.model}
                      </Table.Cell>
                      ...
                      <Table.Cell minW="120px">
                        <HStack gap={2} justifyContent="center">
                          ...
                          <IconButton
                            ...
                            colorPalette="red"
                            onClick={() =>
                              handleDeleteClick(part.id, part.name)
                            }
                            _hover={{ bg: "transparent" }}
                          >
                            <FaTrash />
